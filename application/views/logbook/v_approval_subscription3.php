          ...
          <div class="col-xs-12">
              <div class="box">
                ...
                <table border="0px">
                  ...
                  <tr>
                    <td style="padding: 6px; padding-right: 50px;">Nominal</td>
                    <td style="padding: 3px;"> : </td>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td id="approval_input_s21">
                          ...
                          <?php }
                            elseif ($stat==3 && $data->approval_input_sinvest==4 && $data->approval_input_s21==5) {
                          ?>
                          <select class="form-control" style="width: 100%;" name="approval_input_s21" id="approval_input_s21">
                           <?php
                              foreach ($ref_approval_yesno as $approve){
                        ...
                        <td>
                        <?php
                          if ($stat==5 && $data->approval_head_operation==1 && $data->approval_good_fund==2) {
                        ?>
                          <select class="form-control" style="width: 100%;" name="approval_good_fund" id="approval_good_fund">
                           <?php
                              foreach ($ref_approval_goodfund as $approve){
                        ...
                        <?php }
                          elseif ($stat==3 && $data->approval_head_operation==1 && $data->approval_good_fund==2){
                        ?>
                          <select class="form-control" style="width: 100%;" name="approval_good_fund" id="approval_good_fund">
                           <?php
                              foreach ($ref_approval_goodfund as $approve){
                        ...
                        <?php }
                          elseif ($stat==4 && $data->approval_head_operation==1 && $data->approval_good_fund==2){
                        ?>
                          <select class="form-control" style="width: 100%;" name="approval_good_fund" id="approval_good_fund">
                           <?php
                              foreach ($ref_approval_goodfund as $approve){
                        ...
                        ?>
                          <select class="form-control" style="width: 100%;" id="approval_good_fund" disabled="disabled">
                           <?php
                              foreach ($ref_approval_goodfund as $approve){
                                  $selected=($data->approval_good_fund == $approve->kode_approval)?"selected":"";
                                  echo "<option value='$approve->kode_approval' $selected>$approve->nama_approval</option>";
                          ...
                          <input type="hidden" name="approval_good_fund" value="<?php echo $data->approval_good_fund?>">  
                        <?php }
                        ?>
                        </td>
                        ...
                        <td>
                        <?php
                          if ($stat==5 && $data->approval_good_fund==1 && $data->approval_softcopy==2) {
                        ?>
                        ...
                        <?php }
                          elseif ($stat==3 && $data->approval_good_fund==1 && $data->approval_softcopy==2){
                        ?>
                          <select class="form-control" style="width: 100%;" name="approval_softcopy" id="approval_softcopy">
                           <?php
                              foreach ($ref_approval as $approve){
                        ...
                        <?php }
                          elseif ($stat==4 && $data->approval_good_fund==1 && $data->approval_softcopy==2) {
                        ?>
                          <select class="form-control" style="width: 100%;" name="approval_softcopy" id="approval_softcopy">
                           <?php
                              foreach ($ref_approval as $approve){
