        ...
        <div class="row">
          <div class="col-xs-12">
              <div class="box">
                ...
                <?php 
                      $no=1;
                      if (isset($data_approval_switching)) {
                        foreach ($data_approval_switching as $data) {
                ?>
                <table border="0px">
                  <tr>
                    <td style="padding: 6px; padding-right: 50px;">Kode Switching</td>
                    <td style="padding: 3px;"> : </td>
                    <td style="padding: 3px; width: 900px;"><label class="control_label"><?php echo $data->kode_switching?></label></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="padding: 6px; padding-right: 50px;">Nama Fund Redemption</td>
                    <td style="padding: 3px;"> : </td>
                    <td style="padding: 3px; width: 900px;"><label class="control_label"><?php echo $data->nama_fund_redemption?></label></td>
                  </tr>
                  <tr>
                    <td style="padding: 6px; padding-right: 50px;">Nama Fund Subscription</td>
                    <td style="padding: 3px;"> : </td>
                    <td style="padding: 3px; width: 900px;"><label class="control_label"><?php echo $data->nama_fund_subscription?></label></td>
                  </tr>
                  <tr>
                  ...
                  <table id="" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th class="c_6">Pemindahan Dana</th>
                        <th class="c_7">SC Konfirmasi</th>
                        <th class="c_8">Konfirmasi Asli</th>
                      </tr>
                    </thead>
                    <form class="form-horizontal" method="post" action="<?php echo base_url('logbook/update_approval_switching')?>">
                    <tbody>
                      <tr>
                        ...
                        <td id="approval_input_s21">
                          ...
                          <?php }
                            if ($stat==4 && $data->approval_input_sinvest==4 && $data->approval_input_s21==5) {
                          ?>
                          <select class="form-control" style="width: 100%;" name="approval_input_s21" id="approval_input_s21">
                           <?php
                              foreach ($ref_approval_yesno as $approve){
                          ...
                          <?php }
                            if ($stat==5 && $data->approval_input_sinvest==4 && $data->approval_input_s21==5) {
                          ?>
                          <select class="form-control" style="width: 100%;" name="approval_input_s21" id="approval_input_s21">
                           <?php
                              foreach ($ref_approval_yesno as $approve){
                        ...
                        <td>
                        <?php
                          if ($stat==5 && $data->approval_head_operation==1 && $data->approval_monitoring_pemindahan_dana==2) {
                        ?>
                          <select class="form-control" style="width: 100%;" name="approval_monitoring_pemindahan_dana" id="approval_monitoring_pemindahan_dana">
                           <?php
                              foreach ($ref_approval as $approve){
                                  $selected=($data->approval_monitoring_pemindahan_dana == $approve->kode_approval)?"selected":"";
                                  echo "<option value='$approve->kode_approval' $selected>$approve->nama_approval</option>";
                              }
                            ?>
                          </select>
                        <?php }
                          elseif ($stat==3 && $data->approval_head_operation==1 && $data->approval_monitoring_pemindahan_dana==2) {
                        ?>
                          <select class="form-control" style="width: 100%;" name="approval_monitoring_pemindahan_dana" id="approval_monitoring_pemindahan_dana">
                           <?php
                              foreach ($ref_approval as $approve){
                        ...
                        <?php }
                          if ($stat==4 && $data->approval_head_operation==1 && $data->approval_monitoring_pemindahan_dana==2) {
                        ?>
                          <select class="form-control" style="width: 100%;" name="approval_monitoring_pemindahan_dana" id="approval_monitoring_pemindahan_dana">
                           <?php
                              foreach ($ref_approval as $approve){
                        ...
                        ?>
                          <select class="form-control" style="width: 100%;" id="approval_monitoring_pemindahan_dana" disabled="disabled">
                           <?php
                              foreach ($ref_approval as $approve){
                                  $selected=($data->approval_monitoring_pemindahan_dana == $approve->kode_approval)?"selected":"";
                                  echo "<option value='$approve->kode_approval' $selected>$approve->nama_approval</option>";
                          ...
                          <input type="hidden" name="approval_monitoring_pemindahan_dana" value="<?php echo $data->approval_monitoring_pemindahan_dana?>">  
                        <?php }
                        ?>
                        </td>
                        ...
                        <td>
                        <?php
                          if ($stat==5 && $data->approval_monitoring_pemindahan_dana==1 && $data->approval_softcopy==2) {
                        ?>
                        ...
                        <?php }
                          if ($stat==3 && $data->approval_monitoring_pemindahan_dana==1 && $data->approval_softcopy==2) {
                        ?>
                          <select class="form-control" style="width: 100%;" name="approval_softcopy" id="approval_softcopy">
                           <?php
                              foreach ($ref_approval as $approve){
                        ...
                        <?php }
                          if ($stat==4 && $data->approval_monitoring_pemindahan_dana==1 && $data->approval_softcopy==2) {
                        ?>
                          <select class="form-control" style="width: 100%;" name="approval_softcopy" id="approval_softcopy">
                           <?php
                              foreach ($ref_approval as $approve){
