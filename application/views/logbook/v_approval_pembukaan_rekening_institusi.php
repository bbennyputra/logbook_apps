  ...
  <div class="wrapper">
              ...
              <div class="box">
                ...
                <table border="0px">
                  ...
                  <?php 
                    if ($stat==8) {
                  ?>
                    <form class="form-horizontal" method="post" action="<?php echo base_url('logbook/edit_kelengkapan_dokumen_pojk')?>">
                    <input type="hidden" name="kode_pembukaan_rekening_institusi" value="<?php echo $data->kode_pembukaan_rekening_institusi;?>">
                    <tr>
                      <td style="padding: 6px; padding-right: 50px;">Dokumen POJK</td>
                      <td style="padding: 3px;"> : </td>
                      <td style="padding: 3px; width: 900px;">
                        <select class="form-control" style="width: 25%;" name="checklist_rekening_redemption" id="kelengkapan_pojk">
                          <?php
                            foreach ($ref_approval as $approve){
                              if ($approve->kode_approval!='1') {
                                  $nama_kelengkapan = 'Tidak Lengkap';
                              }
                              else {
                                  $nama_kelengkapan = 'Lengkap';
                              }
                                $selected=($data->checklist_rekening_redemption == $approve->kode_approval)?"selected":"";
                                echo "<option value='$approve->kode_approval' $selected>$nama_kelengkapan</option>";
                            }
                          ?>
                        </select> 
                      </td>
                    ...
                    <tr>
                      ...
                      ?>
                      <td style="padding: 6px; padding-right: 50px;"></td>
                      <td style="padding: 3px;"></td>
                      <td style="padding: 3px; width: 900px;">
                        <textarea class="form-control" rows="3" style="width: 50%;" name="minus_dokumen_pojk" id="desc_pojk_edit1" <?php echo $disable; ?>><?php echo $data->minus_dokumen_pojk?></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td style="padding: 6px; padding-right: 50px;"></td>
                  ...
                  <?php }
                      ...
                      if ($data->checklist_rekening_redemption!='1') {
                          $kelengkapan_pojk1 = 'Tidak Lengkap';
                      }
                      else {
                          $kelengkapan_pojk1 = 'Lengkap';
                      }

                      if ($data->checklist_rekening_redemption!='1') {
                          $minus_pojk = '( ' .$data->minus_dokumen_pojk .' )';
                      }
                      else {
                          $minus_pojk = '';
                      }
                  ?>
                    <tr>
                      <td style="padding: 6px; padding-right: 50px;">Dokumen POJK</td>
                      <td style="padding: 3px;"> : </td>
                      <td style="padding: 3px; width: 900px;"><label class="control_label"><?php echo $kelengkapan_pojk1 .' ' .$minus_pojk?></label></td>
                    </tr>
                  <?php } ?>
                </table>
                </div><!-- /.box-header -->
                  ...
                  <table id="" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <?php
                          if ($stat==2 && $data->checklist_form_pembukaan_rekening=='1' && $data->checklist_npwp=='1' && $data->approval_kadiv_mkt==2) {
                        ?>
                          ...
                          <?php
                            ...
                            elseif ($stat==2 && $data->approval_crm=='1' && $data->checklist_form_pembukaan_rekening!='1' || $data->checklist_npwp!='1') {
                          ?>
                        ...
                        <td id="approval_input_s21">
                          <?php
                            if ($stat==3 && $data->approval_input_s21==5 && $data->approval_input_sinvest==4) {
                          ?>
                          ...
                          <?php
                            ...
                            elseif ($stat==4 && $data->approval_input_s21==5 && $data->approval_input_sinvest==4) {
                          ?>
                          <select class="form-control" style="width: 100%;"  name="approval_input_s21" id="approval_input_s21">
                           <?php
                              foreach ($ref_approval_yesno as $approve){
                          ...
                          <?php
                            ...
                            elseif ($stat==5 && $data->approval_input_s21==5 && $data->approval_input_sinvest==4) {
                          ?>
                          <select class="form-control" style="width: 100%;"  name="approval_input_s21" id="approval_input_s21">
                           <?php
                              foreach ($ref_approval_yesno as $approve){
    ...
    <script type="text/javascript">
      $('#kelengkapan_pojk').on('change', function() {
        if (this.value == '1')
        {   
            $("#desc_pojk_edit1").prop("disabled", true);
            document.clear();
        }
        else if (this.value == '2')
        {   
            $("#desc_pojk_edit1").prop("disabled", false);
        }
      });
    </script>