                  ...
                  <table id="" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <?php
                          if ($data->checklist_form_pembukaan_rekening=='1' && $data->checklist_ktp=='1') {
                        ?>
                          ...
                          <?php
                            ...
                            elseif ($data->approval_crm=='1' && $data->checklist_form_pembukaan_rekening!='1' || $data->checklist_ktp!='1') {
                          ?>
